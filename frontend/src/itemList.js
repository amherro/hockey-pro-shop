...
const Items = [
    ...
    },
    {
        ...
        description: 'The new and improved One-Piece Boot SPEED is all about performance and acceleration, now featuring Game Ready Fit for the ultimate anatomical connection from your foot to your skate, maximizing comfort and force transmission.',
        price: 1149.99,
        img: ft6,
        isFeatured: true
    },
    {
        ...
        description: 'The EFLEX 6.5 goalie skate is lightweight and stiff, with an EVA foam footbed for ergonomic comfort and reliable support, ensuring show-stopping saves.',
        price: 249.99,
        img: goalieSkates,
        isFeatured: true
    },
    {
        ...
        description: 'Releases the puck 5% quicker, with reduced weight and improved recoil speed.',
        price: 219.99,
        img: vapor3x,
        isFeatured: false
    },
    ...
    },
    {
        ...
        description: 'The JETSPEED FT6 PRO hockey stick introduces a brand-new shaft technology, Nanolite Shield, composed of thicker carbon fiber layers protecting the stick\'s ultra-light core.',
        price: 349.99,
        img: ft6Stick,
        isFeatured: false
    },
    {
        ...
        description: 'Nanolite carbon layering technology gives it balance enabling you to unleash accurate shots faster than ever before.',
        price: 349.99,
        img: ft6Stick,
        isFeatured: false
    },
    {
        ...
        description: 'Engineered for the elite and pro-inspired player who doesn’t want to compromise on comfort, protection, or performance, the HYPERLITE 2 HELMET offers an optimum level of performance in a state-of-the-art package.',
        price: 399.99,
        img: hyperliteHelmet,
        isFeatured: true
    },
    {
        ...
        description: '3D wrap Aerolite base creates a round base around the player’s head, reducing the potential for pressure points. Additionally, the 3D wrap Aerolite base helps mitigate high-energy impacts.',
        price: 139.99,
        img: reakt85,
        isFeatured: false
    },
    {
        ...
        description: 'Drawing from the unprecedented success of our SUPER TACKS X helmet, the TACKS 720 hockey helmet was designed to keep your noggin cool, comfortable and protected during every shift.',
        price: 239.99,
        img: tacks720,
        isFeatured: false
    },
    {
        ...
        description: 'Equipped with Fluid Inside™ pods and our rate-sensitive D3O® Smart Material, this bucket is designed to distribute impact energy evenly in complete comfort.',
        price: 239.99,
        img: tacks910,
        isFeatured: true
    },
